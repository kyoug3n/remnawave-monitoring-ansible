...
2. Создайте A-запись, указывающую новый домен на IP-адрес сервера ноды.
...
- Порт 8443 не должен быть занят другим процессом — acme.sh открывает и закрывает его автоматически во время TLS-ALPN challenge
